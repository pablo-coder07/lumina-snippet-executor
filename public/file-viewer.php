<?php
// file-viewer.php - Ver archivos guardados en snippets
?>
<!DOCTYPE html>
<html>
<head>
    ...
    foreach ($files as $file) {
        ...
        <div class="file-item">
            <div class="file-header">
                ...
                <div>
                    <a href="execute-snippet.php" class="btn" 
                       onclick="testExecution('<?php echo htmlspecialchars($shortcode_name); ?>'); return false;">
                        ▶️ Test
                    </a>
                </div>
            </div>
