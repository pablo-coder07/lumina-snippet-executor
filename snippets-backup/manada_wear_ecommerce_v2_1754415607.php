 ...
 * Shortcode: [manada_wear_ecommerce_v2]
 * Fecha: 2025-08-05 17:40:07
 * Timestamp: 1754415607
 * User ID: 1
 */
...
function manada_wear_ecommerce_shortcode() {
    ...
    <style>
        ...
        .manada-v1-hero {
            background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://manadawear.com/wp-content/uploads/2024/04/pets-background.jpg');
...
add_shortcode('manada_wear_ecommerce_v2', 'manada_wear_ecommerce_shortcode');
?>