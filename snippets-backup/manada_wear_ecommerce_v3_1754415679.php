 ...
 * Shortcode: [manada_wear_ecommerce_v3]
 * Fecha: 2025-08-05 17:41:19
 * Timestamp: 1754415679
 * User ID: 1
 */
...
function manada_wear_ecommerce_shortcode() {
            ...
            <div class="manada-v1-products">
                <div class="manada-v1-product">
                    <div class="manada-v1-product-image">
                        <img src="https://manadawear.com/wp-content/uploads/2024/04/termo-pet-mom-era-300x300.png" alt="Termo In My Pet Mom Era">
                    </div>
                ...
                <div class="manada-v1-product">
                    <div class="manada-v1-product-image">
                        <img src="https://manadawear.com/wp-content/uploads/2024/04/227.png" alt="Tote Bag In My Pet Mom Era">
                    </div>
                ...
                <div class="manada-v1-product">
                    <div class="manada-v1-product-image">
                        <img src="https://manadawear.com/wp-content/uploads/2024/04/termo-pet-mom-era.png" alt="Camiseta In My Pet Mom Era">
                    </div>
    ...
    <style>
        ...
        .manada-v1-hero {
            background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://manadawear.com/wp-content/uploads/2024/04/pets-paws-background.jpg');
...
add_shortcode('manada_wear_ecommerce_v3', 'manada_wear_ecommerce_shortcode');
?>